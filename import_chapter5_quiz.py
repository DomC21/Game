...
def import_chapter5_quiz():
    """
    Import the Chapter 5 quiz questions from the markdown file into the database.
    """
    # Create a database session
    db = SessionLocal()
    
    try:
        print("Starting Chapter 5 quiz import...")
        ...
        if existing_quiz:
            ...
            quiz_data = schemas.QuizCreate(
                ...
                description="Comprehensive quiz covering all aspects of portfolio construction and asset allocation.",
                points_reward=100,
                quiz_type="regular",
        ...
        with open("app/content/chapter5/chapter_quiz.md", "r") as f:
            content = f.read()
        ...
        for q_data in questions:
            ...
            if existing_question:
                ...
                db_question = models.Question(
                    ...
                    explanation=f"This question tests understanding of portfolio construction and asset allocation concepts.",
                    quiz_id=quiz.id
                )
                db.add(db_question)
        ...
        print("Chapter 5 quiz import completed successfully!")
        return True
