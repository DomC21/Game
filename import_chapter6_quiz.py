...
def import_chapter6_quiz():
    """
    Import the Chapter 6 quiz questions from the markdown file into the database.
    """
    # Create a database session
    db = SessionLocal()
    
    try:
        print("Starting Chapter 6 quiz import...")
        ...
        existing_quiz = db.query(models.Quiz).filter(
            models.Quiz.title == "Risk Management Strategies Quiz",
        ...
        if existing_quiz:
            ...
            quiz_data = schemas.QuizCreate(
                title="Risk Management Strategies Quiz",
                description="Comprehensive quiz covering all aspects of risk management strategies.",
                points_reward=500,
                quiz_type="regular",
        ...
        with open("app/content/chapter6/chapter_quiz.md", "r") as f:
            content = f.read()
        ...
        for line in answer_key_text.split("\n"):
            ...
            if line and "." in line:
                ...
                if len(parts) >= 2:
                    ...
                    try:
                        answer_key[int(q_num)] = answer
                    except ValueError:
                        print(f"Warning: Could not parse question number from line: {line}")
                        continue
        ...
        for q_data in questions:
            ...
            q_explanation = q_data[2].strip()
            options = [q_data[3], q_data[4], q_data[5], q_data[6]]
        ...
        print("Chapter 6 quiz import completed successfully!")
        return True
