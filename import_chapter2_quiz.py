...
def import_chapter2_quiz():
    """
    Import the Chapter 2 quiz questions from the markdown file into the database.
    """
    # Create a database session
    db = SessionLocal()
    
    try:
        print("Starting Chapter 2 quiz import...")
        ...
        existing_quiz = db.query(models.Quiz).filter(
            models.Quiz.title == "Trading Psychology & Emotional Discipline Quiz",
        ...
        if existing_quiz:
            ...
            quiz_data = schemas.QuizCreate(
                title="Trading Psychology & Emotional Discipline Quiz",
                description="Comprehensive quiz covering all aspects of trading psychology and emotional discipline.",
                points_reward=1000,
                quiz_type="regular",
        ...
        with open("app/content/chapter2/chapter_quiz.md", "r") as f:
            content = f.read()
        ...
        for q_data in questions:
            ...
            if existing_question:
                ...
                db_question = models.Question(
                    ...
                    explanation=f"This question tests understanding of trading psychology concepts.",
                    quiz_id=quiz.id
                )
                db.add(db_question)
        ...
        print("Chapter 2 quiz import completed successfully!")
        return True
