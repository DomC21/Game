...
def import_chapter4_quiz():
    """
    Import the Chapter 4 quiz questions from the markdown file into the database.
    """
    # Create a database session
    db = SessionLocal()
    
    try:
        print("Starting Chapter 4 quiz import...")
        ...
        existing_quiz = db.query(models.Quiz).filter(
            models.Quiz.title == "Fundamental Analysis & Valuation Quiz",
        ...
        if existing_quiz:
            ...
            quiz_data = schemas.QuizCreate(
                title="Fundamental Analysis & Valuation Quiz",
                description="Comprehensive quiz covering all aspects of fundamental analysis and valuation.",
                points_reward=100,
                quiz_type="regular",
        ...
        with open("app/content/chapter4/chapter_quiz.md", "r") as f:
            content = f.read()
        ...
        for q_data in questions:
            ...
            if existing_question:
                ...
                db_question = models.Question(
                    ...
                    explanation=f"This question tests understanding of fundamental analysis concepts.",
                    quiz_id=quiz.id
                )
                db.add(db_question)
        ...
        print("Chapter 4 quiz import completed successfully!")
        return True
